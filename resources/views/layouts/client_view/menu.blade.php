<ul class="hb-dropdown">
                <li class="sub-dropdown-holder"><a href="shop-left-sidebar.html">Laptops</a>
                    <ul class="hb-dropdown hb-sub-dropdown megamenu hb-megamenu">
                ...
                <li class="sub-dropdown-holder"><a href="shop-left-sidebar.html">Audio</a>
                    <ul class="hb-dropdown hb-sub-dropdown megamenu hb-megamenu">
                        <li class="right-menu cat-mega-title">
