                   ...
                   <!-- Product Details Left -->
                    <div class="product-details-left">
                        <div class="product-details-images slider-navigation-1">
                            <div class="lg-image">
                                <a class="popup-img venobox vbox-item" href="{{asset('./client_view/images/product/large-size/1.jpg')}}" data-gall="myGallery">
                                    <img src="{{asset('./client_view/images/product/large-size/1.jpg')}}" alt="product image">
                                </a>
                            </div>
                            <div class="lg-image">
                                <a class="popup-img venobox vbox-item" href="{{asset('./client_view/images/product/large-size/2.jpg')}}" data-gall="myGallery">
                                    <img src="{{asset('./client_view/images/product/large-size/2.jpg')}}" alt="product image">
                                </a>
                            </div>
                            <div class="lg-image">
                                <a class="popup-img venobox vbox-item" href="{{asset('./client_view/images/product/large-size/3.jpg')}}" data-gall="myGallery">
                                    <img src="{{asset('./client_view/images/product/large-size/3.jpg')}}" alt="product image">
                                </a>
                            </div>
                            <div class="lg-image">
                                <a class="popup-img venobox vbox-item" href="{{asset('./client_view/images/product/large-size/4.jpg')}}" data-gall="myGallery">
                                    <img src="{{asset('./client_view/images/product/large-size/4.jpg')}}" alt="product image">
                                </a>
                            </div>
                            <div class="lg-image">
                                <a class="popup-img venobox vbox-item" href="{{asset('./client_view/images/product/large-size/5.jpg')}}" data-gall="myGallery">
                                    <img src="{{asset('./client_view/images/product/large-size/5.jpg')}}" alt="product image">
                                </a>
                            </div>
                            <div class="lg-image">
                                <a class="popup-img venobox vbox-item" href="{{asset('./client_view/images/product/large-size/6.jpg')}}" data-gall="myGallery">
            ...
            <div class="tab-content">
                ...
                <div id="product-details" class="tab-pane" role="tabpanel">
                    <div class="product-details-manufacturer">
                        <a href="#">
                            <img src="{{asset('./client_view/images/product-details/1.jpg')}}" alt="Product Manufacturer Image">
                        </a>
                                            ...
                                            <div class="modal-inner-area row">
                                                <div class="col-lg-6">
                                                   <div class="li-review-product">
                                                       <img src="{{asset('./client_view/images/product/large-size/3.jpg')}}" alt="Li's Product">
