    ...
    <div class="row">
      ...
      <div class="col-md-4">
        ...
        <div class="card card-primary">
          ...
          <!-- /.card-header -->
          <!-- form start -->
          <form action="{{url("/admin/status/product/$product->id/update")}}" method="POST">
            @method('put')
            @csrf
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="exampleInputPassword1" name="product_status" value=" {{$product->status}}  {{old('product_status')}}" placeholder="Enter Sub Category">
                  </div>
